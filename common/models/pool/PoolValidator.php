...
class PoolValidator extends \common\models\BaseModel
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\pool\PoolValidatorQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\pool\PoolValidatorQuery(get_called_class());
    }
