...
class PoolAssign extends \common\models\BaseModel
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\pool\PoolAssignQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\pool\PoolAssignQuery(get_called_class());
    }
	...
	{
		return $this->hasOne(PoolAssignRating::class, ['pool_assign_id' => 'id'])->alias('assignRating');
	}
}