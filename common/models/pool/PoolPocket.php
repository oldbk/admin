...
class PoolPocket extends \common\models\BaseModel
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\query\pool\PoolPocketQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\pool\PoolPocketQuery(get_called_class());
    }
