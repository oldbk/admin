...
class PoolValidatorInfo extends \common\models\BaseModel
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\oldbk\query\pool\PoolValidatorInfoQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\oldbk\query\pool\PoolValidatorInfoQuery(get_called_class());
    }
}