...
class PoolAssignRating extends \common\models\BaseModel
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\oldbk\query\pool\PoolAssignRatingQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\oldbk\query\pool\PoolAssignRatingQuery(get_called_class());
    }
}