...
class PoolPocketItem extends \common\models\BaseModel
{
    ...
    /**
     * @inheritdoc
     * @return \common\models\oldbk\query\pool\PoolPocketItemQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\oldbk\query\pool\PoolPocketItemQuery(get_called_class());
    }
