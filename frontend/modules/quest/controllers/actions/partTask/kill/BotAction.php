...
class BotAction extends Action
{
    public function run($id)
    {
        ...
        return $this->controller->render('kill-bot/create', [
            'model' => $model,
            'item'  => $item,
            'pocket' => $Pocket,
        ]);
