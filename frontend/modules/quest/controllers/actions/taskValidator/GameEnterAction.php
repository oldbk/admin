...
use common\models\validatorItem\GameEnterValidator;
...
class GameEnterAction extends Action
{
    public function run($id)
    {
        ...
        return $this->controller->render('gameEnter/create', [
            'model' => $model,
            'item'  => $item,
