        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                <div class="dialog-quest-form">
                    ...
                    <?= $form->field($item, 'sila')->textInput(['class' => 'form-control touchspin1']) ?>
                    <?= $form->field($item, 'lovk')->textInput(['class' => 'form-control touchspin1']) ?>
                    <?= $form->field($item, 'inta')->textInput(['class' => 'form-control touchspin1']) ?>
                    <?= $form->field($item, 'vinos')->textInput(['class' => 'form-control touchspin1']) ?>
                    <?= $form->field($item, 'intel')->textInput(['class' => 'form-control touchspin1']) ?>
                    <?= $form->field($item, 'mudra')->textInput(['class' => 'form-control touchspin1']) ?>
