...
/* @var $item \common\models\questTask\ItemTask */
...
<div class="quest-part-form">
    ...
    <?php if($model->isNewRecord): ?>
        ...
        <?= $form->field($item, 'category_id')->dropDownList(\yii\helpers\ArrayHelper::merge([0 => 'Любой'], \common\helper\CategoryItemHelper::getLabels())) ?>
    <?php else: ?>
