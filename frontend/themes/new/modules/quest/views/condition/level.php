        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                <div class="dialog-quest-form">
                    ...
                    <?= $form->field($model, 'min_level')->textInput(['class' => 'form-control touchspin1']) ?>
                    <?= $form->field($model, 'max_level')->textInput(['class' => 'form-control touchspin1']) ?>
