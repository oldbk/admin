        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                <div class="dialog-quest-form">
                    ...
                    <?= $form->field($model, 'quest_id')->dropDownList(ArrayHelper::map(\common\models\Quest::find()->orderBy('name asc')->all(), 'id', 'name')) ?>

                    <?= $form->field($model, 'state')->dropDownList(QuestConditionQuest::states()) ?>
